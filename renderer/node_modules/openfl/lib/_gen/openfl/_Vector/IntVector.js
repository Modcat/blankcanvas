// Class: openfl._Vector.IntVector
...
var IntVector = function(length,fixed,array) {
	if(array == null) {
		array = [];
	}
	this.__array = array;
...
IntVector.__name__ = ["openfl","_Vector","IntVector"];
IntVector.__interfaces__ = [(openfl__$Vector_IVector().default)];
IntVector.prototype = {
	concat: function(a) {
		if(a == null) {
			return new IntVector(null,null,this.__array.slice());
		} else {
			return new IntVector(null,null,this.__array.concat(((js_Boot().default).__cast(a , IntVector)).__array));
		}
	},
	copy: function() {
		return new IntVector(null,this.fixed,this.__array.slice());
	},
	get: function(index) {
	...
	slice: function(startIndex,endIndex) {
		...
		return new IntVector(null,null,this.__array.slice(startIndex,endIndex));
	},
	sort: function(f) {
		this.__array.sort(f);
	},
	splice: function(pos,len) {
		return new IntVector(null,null,this.__array.splice(pos,len));
	},
	toJSON: function() {
		return this.__array;
	},
...
IntVector.prototype.__class__ = $hxClasses["openfl._Vector.IntVector"] = IntVector;

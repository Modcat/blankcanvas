// Class: openfl._Vector.BoolVector
...
var BoolVector = function(length,fixed,array) {
	if(array == null) {
		array = [];
	}
	this.__array = array;
...
BoolVector.__name__ = ["openfl","_Vector","BoolVector"];
BoolVector.__interfaces__ = [(openfl__$Vector_IVector().default)];
BoolVector.prototype = {
	concat: function(a) {
		if(a == null) {
			return new BoolVector(null,null,this.__array.slice());
		} else {
			return new BoolVector(null,null,this.__array.concat(((js_Boot().default).__cast(a , BoolVector)).__array));
		}
	},
	copy: function() {
		return new BoolVector(null,this.fixed,this.__array.slice());
	},
	get: function(index) {
	...
	slice: function(startIndex,endIndex) {
		...
		return new BoolVector(null,null,this.__array.slice(startIndex,endIndex));
	},
	sort: function(f) {
		this.__array.sort(f);
	},
	splice: function(pos,len) {
		return new BoolVector(null,null,this.__array.splice(pos,len));
	},
	toJSON: function() {
		return this.__array;
	},
...
BoolVector.prototype.__class__ = $hxClasses["openfl._Vector.BoolVector"] = BoolVector;
